...
bool pair_Cs(const pair<string, ll>& firstElof, const pair<string, ll>& secondElof) {
    return firstElof.second < secondElof.second;
}

bool pair_Cs_R(const pair<string, ll>& firstElof, const pair<string, ll>& secondElof) {
    return firstElof.second > secondElof.second;
}
